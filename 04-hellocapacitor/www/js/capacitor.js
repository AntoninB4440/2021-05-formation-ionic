...
var capacitorExports = (function (e) {
  ...
  ((t = e.CameraSource || (e.CameraSource = {})).Prompt = "PROMPT"),
    (t.Camera = "CAMERA"),
    (t.Photos = "PHOTOS"),
    ((r = e.CameraDirection || (e.CameraDirection = {})).Rear = "REAR"),
    (r.Front = "FRONT"),
    ((n = e.CameraResultType || (e.CameraResultType = {})).Uri = "uri"),
    (n.Base64 = "base64"),
    (n.DataUrl = "dataUrl"),
    ((i = e.FilesystemDirectory || (e.FilesystemDirectory = {})).Documents =
      "DOCUMENTS"),
    (i.Data = "DATA"),
    (i.Cache = "CACHE"),
    (i.External = "EXTERNAL"),
    (i.ExternalStorage = "EXTERNAL_STORAGE"),
    ((o = e.FilesystemEncoding || (e.FilesystemEncoding = {})).UTF8 = "utf8"),
    (o.ASCII = "ascii"),
    (o.UTF16 = "utf16"),
    ((s = e.HapticsImpactStyle || (e.HapticsImpactStyle = {})).Heavy = "HEAVY"),
    (s.Medium = "MEDIUM"),
    (s.Light = "LIGHT"),
    ((a =
      e.HapticsNotificationType || (e.HapticsNotificationType = {})).SUCCESS =
      "SUCCESS"),
    (a.WARNING = "WARNING"),
    (a.ERROR = "ERROR"),
    ((u = e.KeyboardStyle || (e.KeyboardStyle = {})).Dark = "DARK"),
    (u.Light = "LIGHT"),
    ((c = e.KeyboardResize || (e.KeyboardResize = {})).Body = "body"),
    (c.Ionic = "ionic"),
    (c.Native = "native"),
    (c.None = "none"),
    ((l = e.ActionSheetOptionStyle || (e.ActionSheetOptionStyle = {})).Default =
      "DEFAULT"),
    (l.Destructive = "DESTRUCTIVE"),
    (l.Cancel = "CANCEL"),
    ((d = e.PermissionType || (e.PermissionType = {})).Camera = "camera"),
    (d.Photos = "photos"),
    (d.Geolocation = "geolocation"),
    (d.Notifications = "notifications"),
    (d.ClipboardRead = "clipboard-read"),
    (d.ClipboardWrite = "clipboard-write"),
  ...
  var m,
    v = (function () {
                ...
                if (void 0 === t[r]) {
                  ...
                  return new Proxy(
                    {},
                    {
                      get: function (e, t) {
                        return void 0 === e[t]
                          ? n.pluginMethodNoop.bind(n, e, t, r)
                          : e[t];
                      },
                    }
                  );
      ...
      return (
        (e.prototype.pluginMethodNoop = function (e, t, r) {
      ...
      return (
        ...
        (e.prototype.loadPlugin = function (e) {
          ...
          t
            ? t.load()
            : console.error(
                "Unable to load web plugin " + e + ", no such plugin found."
              );
        }),
    ...
    P = (function () {
      function e(e, t) {
        (this.config = e),
          ...
          t ? t.addPlugin(this) : b.addPlugin(this);
      }
      return (
  ...
  var A = (function (e) {
      function t() {
        return (
          e.call(this, { name: "Accessibility", platforms: ["web"] }) || this
        );
      }
      return (
        R(t, e),
    ...
    O = (function (t) {
      ...
      return (
        R(r, t),
        (r.prototype.getPhoto = function (e) {
          return C(this, void 0, void 0, function () {
            var t = this;
                      ...
                      switch (o.label) {
                        case 0:
                          return e.webUseInput
                            ? (this.fileInputExperience(e, r), [3, 7])
                            : [3, 1];
                        case 1:
                          if (!customElements.get("pwa-camera-modal"))
                            return [3, 6];
                          (t = document.createElement("pwa-camera-modal")),
                            document.body.appendChild(t),
                            (o.label = 2);
                        case 2:
                          return (
                            o.trys.push([2, 4, , 5]), [4, t.componentOnReady()]
                          );
                        case 3:
                          return (
                            o.sent(),
                              ...
                              return C(i, void 0, void 0, function () {
                                ...
                                return T(this, function (a) {
                                  switch (a.label) {
                                    ...
                                    case 2:
                                      return (
                                        (s = r), [4, this._getCameraPhoto(i, e)]
                                      );
                                    case 3:
                                      s.apply(void 0, [a.sent()]),
                                        (a.label = 4);
                                    case 4:
                                      return (
                                        t.dismiss(),
                        ...
                        case 4:
                          return (
                            o.sent(), this.fileInputExperience(e, r), [3, 5]
                          );
                        case 5:
                          return [3, 7];
                        case 6:
        ...
        (r.prototype.fileInputExperience = function (t, r) {
          ...
          n ||
            ...
            (n.accept = "image/*"),
            (n.capture = !0),
            t.source === e.CameraSource.Photos ||
            t.source === e.CameraSource.Prompt
              ? n.removeAttribute("capture")
              : t.direction === e.CameraDirection.Front
              ? (n.capture = "user")
              : t.direction === e.CameraDirection.Rear &&
                (n.capture = "environment"),
            n.addEventListener("change", function (o) {
              var s = n.files[0],
                a = "jpeg";
              if (
                ("image/png" === s.type
                  ? (a = "png")
                  : "image/gif" === s.type && (a = "gif"),
                t.resultType === e.CameraResultType.DataUrl ||
                  t.resultType === e.CameraResultType.Base64)
              ) {
                var u = new FileReader();
                u.addEventListener("load", function () {
                  if (t.resultType === e.CameraResultType.DataUrl)
                    r({ dataUrl: u.result, format: a });
                  else if (t.resultType === e.CameraResultType.Base64) {
                    var n = u.result.split(",")[1];
                    r({ base64String: n, format: a });
                  }
                  i();
                }),
                  u.readAsDataURL(s);
              } else r({ webPath: URL.createObjectURL(s), format: a }), i();
            }),
            n.click();
        }),
        (r.prototype._getCameraPhoto = function (t, r) {
          return new Promise(function (n, i) {
            var o = new FileReader(),
              s = t.type.split("/")[1];
            r.resultType === e.CameraResultType.Uri
              ? n({ webPath: URL.createObjectURL(t), format: s })
              : (o.readAsDataURL(t),
                (o.onloadend = function () {
                  var t = o.result;
                  r.resultType === e.CameraResultType.DataUrl
                    ? n({ dataUrl: t, format: s })
                    : n({ base64String: t.split(",")[1], format: s });
                }),
            ...
            return T(this, function (i) {
              switch (i.label) {
                ...
                case 5:
                  return (
                    (t = i.sent()),
                    (r = new ClipboardItem((((n = {})[t.type] = t), n))),
                    [4, navigator.clipboard.write([r])]
                  );
                case 6:
                  return i.sent(), [3, 8];
                case 7:
          ...
          return C(this, void 0, void 0, function () {
            ...
            return T(this, function (i) {
              switch (i.label) {
                ...
                case 1:
                  return (
                    i.trys.push([1, 5, , 6]), [4, navigator.clipboard.read()]
                  );
                case 2:
                  return (
                    (e = i.sent()), (t = e[0].types[0]), [4, e[0].getType(t)]
                  );
                case 3:
                  return (r = i.sent()), [4, this._getBlobData(r, t)];
                case 4:
                  return (
                    (n = i.sent()), [2, Promise.resolve({ value: n, type: t })]
                  );
                case 5:
    ...
    k = (function (t) {
      function r() {
        var r =
          t.call(this, { name: "Filesystem", platforms: ["web"] }) || this;
        return (
          (r.DEFAULT_DIRECTORY = e.FilesystemDirectory.Data),
          (r.DB_VERSION = 1),
          (r.DB_NAME = "Disc"),
          (r._writeCmds = ["add", "put", "delete"]),
          r
        );
      }
      return (
        R(r, t),
        (r.prototype.initDb = function () {
          return C(this, void 0, void 0, function () {
            var e = this;
            return T(this, function (t) {
          ...
          return C(this, void 0, void 0, function () {
            ...
            return T(this, function (d) {
              switch (d.label) {
                ...
                case 1:
                  if ((i = d.sent()) && "directory" === i.type)
                    throw "The supplied path is a directory.";
                  return (
                    (o = e.encoding),
                    (s = t.substr(0, t.lastIndexOf("/"))),
                    [4, this.dbRequest("get", [s])]
                  );
                case 2:
                  return void 0 !== d.sent() || -1 === (a = s.indexOf("/", 1))
                    ? [3, 4]
                    : ((u = s.substr(a)),
                      [
                        4,
          ...
          return C(this, void 0, void 0, function () {
            ...
            return T(this, function (l) {
              switch (l.label) {
                ...
                case 1:
                  if ((s = l.sent()) && "directory" === s.type)
                    throw "The supplied path is a directory.";
                  return [4, this.dbRequest("get", [n])];
                case 2:
                  return void 0 !== l.sent()
                    ? [3, 4]
                    : ((a = n.indexOf("/", 1)),
                      (u = -1 !== a ? n.substr(a) : "/"),
                      [
                ...
                case 4:
                  return (
                    void 0 !== s && ((r = s.content + r), (o = s.ctime)),
                    (c = {
                      path: t,
                      folder: n,
                      type: "file",
            ...
            return T(this, function (d) {
              switch (d.label) {
                ...
                case 1:
                  ...
                  return [4, this.readdir({ path: t, directory: r })];
                case 2:
                  if (0 !== (s = d.sent()).files.length && !n)
                    throw Error("Folder is not empty");
                ...
                case 3:
                  return a < u.length
                    ? ((c = u[a]),
                      (l = t + "/" + c),
                      [4, this.stat({ path: l, directory: r })])
                    : [3, 9];
                case 4:
                  return "file" !== d.sent().type
                    ? [3, 6]
                    : [4, this.deleteFile({ path: l, directory: r })];
                case 5:
                  return d.sent(), [3, 8];
                case 6:
                  return [
                    4,
                    this.rmdir({ path: l, directory: r, recursive: n }),
                  ];
                case 7:
                  d.sent(), (d.label = 8);
                case 8:
              ...
              return T(this, function (w) {
                switch (w.label) {
                  ...
                  case 1:
                    return (
                      w.trys.push([1, 3, , 6]),
                      [4, this.stat({ path: r, directory: o })]
                    );
                  case 2:
                    return (u = w.sent()), [3, 6];
                  case 3:
                    return (
                      ...
                      (l = c.join("/")),
                      c.length > 0
                        ? [4, this.stat({ path: l, directory: o })]
                        : [3, 5]
                    );
                  case 4:
                    if ("directory" !== w.sent().type)
                      throw new Error(
                  ...
                  case 6:
                    ...
                    return [4, this.stat({ path: n, directory: i })];
                  case 7:
                    switch (
                      ((d = w.sent()),
                      (p = function (e, t, r) {
                    ...
                    return [3, 28];
                  case 8:
                    return [4, this.readFile({ path: n, directory: i })];
                  case 9:
                    return (
                      (h = w.sent()),
                      t
                        ? [4, this.deleteFile({ path: n, directory: i })]
                        : [3, 11]
                    );
                  case 10:
                    w.sent(), (w.label = 11);
                  case 11:
                    return [
                      4,
                      this.writeFile({ path: r, directory: o, data: h.data }),
                    ];
                  case 12:
                  ...
                  case 16:
                    return (
                      w.trys.push([16, 20, , 21]),
                      [4, this.mkdir({ path: r, directory: o, recursive: !1 })]
                    );
                  case 17:
                  ...
                  case 20:
                    return w.sent(), [3, 21];
                  case 21:
                    return [4, this.readdir({ path: n, directory: i })];
                  case 22:
                  ...
                  case 26:
                    return t
                      ? [4, this.rmdir({ path: n, directory: i })]
                      : [3, 28];
                  case 27:
                    w.sent(), (w.label = 28);
                  case 28:
    ...
    B = (function (e) {
      function t() {
        return (
          e.call(this, { name: "Geolocation", platforms: ["web"] }) || this
        );
      }
      return (
        R(t, e),
          ...
          return new Promise(function (r, n) {
            return t.requestPermissions().then(function (t) {
              window.navigator.geolocation.getCurrentPosition(
                ...
                j({ enableHighAccuracy: !0, timeout: 1e4, maximumAge: 0 }, e)
              );
            });
          });
        }),
    ...
    M = (function (e) {
      ...
      return (
        ...
        (t.prototype.parseUa = function (e) {
          var t = {},
            r = e.indexOf("(") + 1,
            n = e.indexOf(") AppleWebKit");
          -1 !== e.indexOf(") Gecko") && (n = e.indexOf(") Gecko"));
    ...
    G = (function (e) {
      function t() {
        var t =
          e.call(this, { name: "LocalNotifications", platforms: ["web"] }) ||
          this;
        return (t.pending = []), t;
      }
      return (
        ...
        (t.prototype.sendPending = function () {
          ...
          this.pending.forEach(function (n) {
            n.schedule &&
              n.schedule.at &&
              +n.schedule.at <= r &&
              (e.buildNotification(n), t.push(n));
          }),
        ...
        (t.prototype.requestPermissions = function () {
          return new Promise(function (e, t) {
            Notification.requestPermission(function (r) {
              "denied" !== r && "default" !== r ? e({ results: [r] }) : t(r);
            });
          });
        }),
        t
      ...
      return (
        ...
        (t.prototype.share = function (e) {
          return navigator.share
            ? navigator.share({ title: e.title, text: e.text, url: e.url })
              ...
              return [
                ...
                new Promise(function (r, n) {
                  return C(t, void 0, void 0, function () {
                    ...
                    return T(this, function (i) {
                      return (
                        (t = document.querySelector("pwa-action-sheet")) ||
                          ((t = document.createElement("pwa-action-sheet")),
                          document.body.appendChild(t)),
                        (t.header = e.title),
                        (t.cancelable = !1),
                        (t.options = e.options),
      ...
      return (
        ...
        (t.prototype.getStatus = function () {
          return new Promise(function (e, t) {
            if (window.navigator) {
              ...
              e({ connected: r, connectionType: r ? i : "none" });
        ...
        (t.prototype.addListener = function (e, t) {
          var r =
            ...
            i = t.bind(this, { connected: !0, connectionType: n }),
        ...
        (r.prototype.query = function (t) {
          return C(this, void 0, void 0, function () {
            ...
            return T(this, function (i) {
              switch (i.label) {
                case 0:
                  return (r = window.navigator).permissions
                    ? ((n =
                        t.name === e.PermissionType.Photos ? "camera" : t.name),
                      [4, r.permissions.query({ name: n })])
                    : [
                        2,
                        Promise.reject(
    ...
    ne = (function (e) {
      function t() {
        return (
          e.call(this, { name: "SplashScreen", platforms: ["web"] }) || this
        );
      }
      return (
        R(t, e),
    ...
    oe = (function (e) {
      ...
      return (
        ...
        (t.prototype.get = function (e) {
          var t = this;
          return new Promise(function (r, n) {
            r({ value: window.localStorage.getItem(t.makeKey(e.key)) });
          });
        }),
          ...
          return C(this, void 0, void 0, function () {
            ...
            return T(this, function (n) {
              return (
                ...
                ((r = document.createElement("pwa-toast")).duration = t),
                (r.message = e.text),
  ...
  return (
    (e.Accessibility = L),
    (e.AccessibilityPluginWeb = A),
    (e.App = F),
    (e.AppPluginWeb = D),
    (e.Browser = N),
    (e.BrowserPluginWeb = I),
    (e.Camera = _),
    (e.CameraPluginWeb = O),
    (e.Capacitor = y),
    (e.Clipboard = U),
    (e.ClipboardPluginWeb = W),
    (e.Device = V),
    (e.DevicePluginWeb = M),
    (e.Filesystem = q),
    (e.FilesystemPluginWeb = k),
    (e.Geolocation = K),
    (e.GeolocationPluginWeb = B),
    (e.LocalNotifications = H),
    (e.LocalNotificationsPluginWeb = G),
    (e.Modals = $),
    (e.ModalsPluginWeb = Y),
    (e.Motion = Q),
    (e.MotionPluginWeb = J),
    (e.Network = ee),
    (e.NetworkPluginWeb = Z),
    (e.Permissions = re),
    (e.PermissionsPluginWeb = te),
    (e.Plugins = g),
    (e.Share = X),
    (e.SharePluginWeb = z),
    (e.SplashScreen = ie),
    (e.SplashScreenPluginWeb = ne),
    (e.Storage = se),
    (e.StoragePluginWeb = oe),
    (e.Toast = ue),
    (e.ToastPluginWeb = ae),
    (e.WebPlugin = P),
    (e.WebPluginRegistry = w),
    (e.WebPlugins = b),
    (e.mergeWebPlugin = E),
    (e.mergeWebPlugins = S),
    (e.registerWebPlugin = function (e) {
      E(g, e);
    }),
    e
  );
